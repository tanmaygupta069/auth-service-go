...
func (x *ValidateTokenResponse) GetRes() bool {
	if x != nil {
		return x.Res
	}
	return false
...
var file_proto_auth_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x29, 0x0a, 0x15,
	...
	0x28, 0x08, 0x52, 0x03, 0x72, 0x65, 0x73, 0x22, 0x38, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f,
...
var file_proto_auth_proto_depIdxs = []int32{
	...
	4, // 4: auth.authService.VaidateToken:input_type -> auth.ValidateTokenRequest
	1, // 5: auth.authService.Login:output_type -> auth.LoginResponse
	3, // 6: auth.authService.Signup:output_type -> auth.SignupResponse
	5, // 7: auth.authService.VaidateToken:output_type -> auth.ValidateTokenResponse
